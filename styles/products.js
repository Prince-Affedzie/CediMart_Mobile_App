...
export const styles = StyleSheet.create({
  ...
  heroSearchGoBtn: { backgroundColor: C.brand, paddingHorizontal: 14, paddingVertical: 13 },
  ...
  subCatPill: {
    ...
    backgroundColor: C.white, borderWidth: 1, borderColor: '#E0E0E0',
  },
  subCatPillActive: { backgroundColor: C.brandBg, borderColor: C.brandBorder },
  ...
  negTag: { backgroundColor: C.accent, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 5 },
  ...
  gridCard: {
    ...
    shadowOpacity: 0.06, shadowRadius: 8, elevation: 4, marginBottom: 2,
  },
  ...
  gridAddBtnDisabled: { backgroundColor: C.t3, shadowOpacity: 0 },
  gridQtyPill: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: C.brandBg, borderRadius: 20,
    paddingHorizontal: 3, paddingVertical: 3,
    borderWidth: 1.5, borderColor: C.brandBorder, gap: 2,
  },
  gridQtyBtn: {
  ...
  gridQtyNum: { fontSize: 13, fontWeight: '800', color: C.brand, minWidth: 22, textAlign: 'center' },

  // ── List card ───────────────────────────────────────────────────────────────
  listWrap: { paddingHorizontal: 12, gap: 10, paddingTop: 4 },
  listCard: {
    flexDirection: 'row', backgroundColor: C.white, borderRadius: 16, overflow: 'hidden',
    shadowColor: C.black, shadowOffset: { width: 0, height: 3 },
  ...
  listName: { fontSize: 14, fontWeight: '700', color: C.t1, flex: 1, lineHeight: 19 },
  listCatChip: {
  ...
  listSubCat: { fontSize: 10, color: C.t3, fontWeight: '500', marginBottom: 6, textTransform: 'capitalize' },
  listBottomRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  listPrice: { fontSize: 16, fontWeight: '800', color: C.accent },
  listQtyPill: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: C.brandBg, borderRadius: 20,
    paddingHorizontal: 4, paddingVertical: 3,
    borderWidth: 1.5, borderColor: C.brandBorder, gap: 4,
  },
  listQtyBtn: {
  ...
  listQtyNum: { fontSize: 14, fontWeight: '800', color: C.brand, minWidth: 26, textAlign: 'center' },
  listCartBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: C.brand, paddingHorizontal: 11, paddingVertical: 8, borderRadius: 10,
    shadowColor: C.brand, shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.25, shadowRadius: 4, elevation: 3,
  },
  listCartBtnOos: { backgroundColor: C.t3, shadowOpacity: 0 },
  ...
  sheetTitle: { fontSize: 17, fontWeight: '800', color: C.brand, marginBottom: 14 },
  sheetRow: {
    flexDirection: 'row', alignItems: 'center',
  ...
  filterChipActive: { backgroundColor: C.brandBg, borderColor: C.brandBorder },
  ...
  clearFiltersBtnText: { color: C.t3, fontSize: 13, fontWeight: '600' },

  // ── States ──────────────────────────────────────────────────────────────────
  loadingWrap: { alignItems: 'center', paddingVertical: 60 },
  loadingText: { marginTop: 14, fontSize: 14, color: C.t3 },
  emptyState: { alignItems: 'center', paddingVertical: 64, paddingHorizontal: 40 },
  emptyIconBg: {
    width: 88, height: 88, borderRadius: 44,
    backgroundColor: C.brandBg, justifyContent: 'center', alignItems: 'center', marginBottom: 20,
  },
  ...
  resetBtn: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: C.brand, paddingHorizontal: 22, paddingVertical: 12,
  ...
  loadMoreBtn: {
    ...
    borderRadius: 14, backgroundColor: C.brandBg,
    borderWidth: 1.5, borderColor: C.brandBorder, gap: 8,
  },
  loadMoreText: { color: C.brand, fontSize: 14, fontWeight: '700' },
  ...
  toast: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: C.brandD, paddingHorizontal: 18, paddingVertical: 12,
  ...
  toastIcon: {
    width: 22, height: 22, borderRadius: 11,
    backgroundColor: C.brandL, justifyContent: 'center', alignItems: 'center',
  },
  toastText: { fontSize: 13, color: 'rgba(255,255,255,0.9)', flex: 1 },
  toastBold: { fontWeight: '700', color: '#fff' },

  // ─── Discount styles for Grid Card ──────────────────────────────────────────
  discountBadgeGrid: {
    position: 'absolute',
    top: 8,
    right: 8,

...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 20, paddingTop: 12, paddingBottom: 28, marginBottom: 12,
  },
  headerTopRow: {
  ...
  headerStoreName: { fontSize: 22, fontWeight: '800', color: '#FFFFFF', letterSpacing: -0.4, maxWidth: width - 120 },
  ...
  profileBand: {
    ...
    backgroundColor: 'rgba(0,0,0,0.18)', borderRadius: 16, padding: 13, gap: 12,
  },
  ...
  profileInitial: { fontSize: 19, fontWeight: '800', color: '#1B5E20' },
  profileInfo: { flex: 1 },
  profileName: { fontSize: 15, fontWeight: '700', color: '#FFFFFF' },
  profileMeta: { fontSize: 12, color: '#A5D6A7', marginTop: 2 },
  verifiedBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: '#388E3C', borderRadius: 20, paddingHorizontal: 10, paddingVertical: 6,
  },
  pendingBadge: { backgroundColor: '#E65100' },
  badgeDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#A5D6A7' },
  badgeDotPending: { backgroundColor: '#FFCC80' },
  ...
  errorBannerText: { flex: 1, fontSize: 13, color: '#B71C1C', fontWeight: '500' },
  ...
  statIconWrap: { width: 42, height: 42, borderRadius: 13, justifyContent: 'center', alignItems: 'center', flexShrink: 0 },
  statRight: { flex: 1 },
  statValue: { fontSize: 20, fontWeight: '800', color: '#1B2714', letterSpacing: -0.3 },
  statLabel: { fontSize: 11, color: '#888888', fontWeight: '500', marginTop: 2 },
  statHint: { fontSize: 10, color: '#BBBBBB', marginTop: 2 },

  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  sectionTitle: { fontSize: 15, fontWeight: '700', color: '#1B2714' },
  seeAllText: { fontSize: 12, fontWeight: '600', color: '#2E7D32' },

  actionsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 22 },
  actionCard: {
    width: (width - 42) / 2, backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.05, shadowRadius: 6, elevation: 2,
  },
  ...
  actionLabel: { fontSize: 14, fontWeight: '700', color: '#1B2714', marginBottom: 3 },
  actionLabelDisabled: { color: '#9E9E9E' },
  actionHint: { fontSize: 11, color: '#AAAAAA' },

  productsSection: { marginBottom: 4 },
  productsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  productCard: {
    width: CARD_WIDTH, backgroundColor: '#FFFFFF', borderRadius: 14,
  ...
  productImgPlaceholder: {
    width: '100%', height: 130, backgroundColor: '#E8F5E9',
  ...
  emptySub: { fontSize: 13, color: '#9E9E9E', textAlign: 'center', lineHeight: 19, marginBottom: 20 },
  emptyBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    backgroundColor: '#2E7D32', paddingHorizontal: 20, paddingVertical: 12, borderRadius: 14,
  },
